...
This project is a fork of [BitChat Android](https://github.com/nicklausw/bitchat-android) by permissionless tech, llc, published under the GNU General Public License v3.
...
The BLE mesh protocol is unmodified from upstream BitChat and can be updated independently.

Upstream repository: https://github.com/nicklausw/bitchat-android
