...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    var showLocationDropSheet by remember { mutableStateOf(false) }
    ...
    ChatInputSection(
        ...
        onCommandSuggestionClick = { suggestion: CommandSuggestion ->
                ...
                onLocationDrop = { showLocationDropSheet = true }
            )
        }
    ...
    // Location Drop Sheet
    if (showLocationDropSheet) {
        LocationDropSheet(
            onDismiss = { showLocationDropSheet = false },
            onSend = { formattedMessage ->
                viewModel.sendMessage(formattedMessage)
                showLocationDropSheet = false
            }
        )
    }
