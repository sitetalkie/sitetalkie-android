...
object AppConstants {
    ...
    object Mesh {
        ...
        object Gatt {
            ...
            val SERVICE_UUID_IOS_DEBUG: UUID = UUID.fromString("F47B5E2D-4A9E-4C5A-9B3F-8E1D2C3A4B5A")
            val SCAN_SERVICE_UUIDS: List<UUID> = listOf(SERVICE_UUID, SERVICE_UUID_IOS_DEBUG)
